...
layui.define(["layer", "laytpl", "upload"], function(i) {
    ...
    var x, b, w, k, C, S = function(i, a, n) {
        ...
        I = function(i) {
            return b && t.close(b.attr("times")), x && x.hide(), L.mine = L.mine || {}, t.open({
                ...
                offset: "rb",
                resize: !1,
                content: '<img src="' + (L.mine.avatar || layui.cache.dir + "css/pc/layim/skin/logo.jpg") + '"><span>' + (i || L.base.title || "我的LayIM") + "</span>",
        ...
        T = function(i) {
            ...
            if (a[0]) {
                ...
                return "none" === w.css("display") && w.show(), k && t.close(k.attr("times")), 1 !== s.find("li").length || o[0] || (d || w.css("width", 800), s.css({
                    height: w.height()
                }).show(), c.css("margin-left", "200px")), o[0] || (s.append(n(v).render(l)), c.append(n(f).render(l)), z(i), E()), O(s.find(".layim-chatlist-" + i.type + i.id)), o[0] || U(), $(i), Q(), C
            }
            l.first = !0;
            var u = C = t.open({
                type: 1,
                ...
                success: function(a) {
                    w = a, a.css({
                        "min-width": "500px",
                        "min-height": "520px"
                    }), z(i), "function" == typeof i.success && i.success(a), Q(), _(a), $(i), U(), q(), layui.each(r.chatChange, function(i, a) {
                        a && a(R())
        ...
        _ = function(i) {
            ...
            i.css({
                "background-image": e ? "url(" + e + ")" : function() {
                    return L.base.initSkin ? "url(" + (layui.cache.dir + "css/modules/layim/skin/" + L.base.initSkin) + ")" : "none"
                }()
            })
        },
        $ = function(i) {
        ...
        K = function(i) {
            ...
            var a = e(".layim-chatlist-" + i.type + i.id),
                t = {},
                l = a.index();
            if (i.timestamp = i.timestamp || (new Date).getTime(), i.fromid == L.mine.id && (i.mine = !0), i.system || B(i), G = JSON.parse(JSON.stringify(i)), L.base.voice && F(), !w && i.content || l === -1) {
        ...
        P = function(i) {
            ...
            var e = {};
            if(x){
                var l = x.find(".layim-list-" + i.type);
            }
            if (L[i.type])
                if ("friend" === i.type) layui.each(L.friend, function(n, l) {
                    if (i.groupid == l.id) return layui.each(L.friend[n].list, function(e, t) {
                        ...
                        anim: 6
                    }) : (L.friend[n].list = L.friend[n].list || [], e[L.friend[n].list.length] = i, i.groupIndex = n, L.friend[n].list.push(i), !0)
                });
                else if ("group" === i.type) {
            ...
            if (!a) {
                ...
                if ("friend" === i.type) {
                    ...
                    o.find(".layui-layim-list").append(s), o.find(".layim-count").html(L.friend[i.groupIndex].list.length), o.find(".layim-null")[0] && o.find(".layim-null").remove()
            ...
            L[i.type] && ("friend" === i.type ? layui.each(L.friend, function(e, t) {
                layui.each(t.list, function(t, n) {
                    if (i.id == n.id) {
                        ...
                        return l.find(".layui-layim-list>li").eq(t).remove(), L.friend[e].list.splice(t, 1), l.find(".layim-count").html(L.friend[e].list.length), 0 === L.friend[e].list.length && l.find(".layui-layim-list").html('<li class="layim-null">该分组下已无好友了</li>'), !0
                    }
                })
            }) : "group" === i.type && layui.each(L.group, function(e, t) {
                if (i.id == t.id) return a.find(">li").eq(e).remove(), L.group.splice(e, 1), 0 === L.group.length && a.html('<li class="layim-null">暂无群组</li>'), !0
            }))
        },
        Z = function() {
            var i = R(),
        ...
        ti = {
            ...
            search: function(i) {
                ...
                !L.base.isfriend && L.base.isgroup ? ti.tab.index = 1 : L.base.isfriend || L.base.isgroup || (ti.tab.index = 2), a.show(), t.focus(), t.off("keyup", n).on("keyup", n)
            },
            ...
            chat: function(i) {
                var a = layui.data("layim")[L.mine.id] || {},
                    ...
                    l = {};
                "friend" === e ? l = L[e][t].list[n] : "group" === e ? l = L[e][n] : "history" === e && (l = (a.history || {})[t] || {}), l.name = l.name || l.username || l.groupname, "history" !== e && (l.type = e), T(l)
            },
            tabChat: function(i) {
                O(i)
            },
    ...
    i("layim", new c)
}).addcss("modules/layim/layim.css?v=3.9.5", "skinlayimcss");