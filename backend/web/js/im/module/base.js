...
YX.fn.openChatBox = function (account, scene) {
    ...
    if(scene=="p2p"){
        ...
        if(info.account == userUID){
            ...
            this.$chatTitle.find('img').attr('src', "/images/im/myPhone.png") 
        }else{
        ...
        if(info){
            if(info.avatar){
                ...
                this.$chatTitle.find('img').attr('src', "/images/im/" + info.type + ".png") 
            }
            ...
            this.$chatTitle.find('img').attr('src', "/images/im/normal.png") 
    ...
    switch(type){
        case "session":   
            ...
            if(scene==="p2p"){
                ...
                if(msg.target === userUID){
                    info.nick = "我的手机"
                    info.avatar = "/images/im/myPhone.png"
                }else{
                ...
                if(teamInfo){
                    ...
                    if(teamInfo.avatar){
                        ...
                        info.avatar = "/images/im/"+teamInfo.type+".png"
                    }
                }else{
                    info.nick = msg.target
                    info.avatar = "/images/im/normal.png"
                }   
            }
        break
        case "friend":
        ...
        case "team":
            ...
            if(data.avatar){
                ...
                info.avatar = info.type==="normal"?"/images/im/normal.png":"/images/im/advanced.png"
            }
            info.crtSession = this.crtSession  
        break
    }
